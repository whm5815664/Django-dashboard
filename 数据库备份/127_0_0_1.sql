...
INSERT INTO `devices` (`id`, `device_name`, `created_at`) VALUES
(1, 'sensor_readings1', '2026-01-12 16:00:00');
...
DROP TABLE IF EXISTS `screen_basemap`;
CREATE TABLE IF NOT EXISTS `screen_basemap` (
  `baseID` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `baseName` varchar(20) COLLATE utf8mb4_unicode_ci NOT NULL,
...
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='基地信息';

--
-- 转存表中的数据 `screen_basemap`
--

INSERT INTO `screen_basemap` (`baseID`, `baseName`, `longitude`, `latitude`, `province`, `city`, `description`) VALUES
('002', '华中农业大学实验田2', 114.367824, 30.471571, '湖北', '武汉', '测试用地2'),
('001', '华中农业大学实验田1', 114.359541, 30.467539, '湖北', '武汉', '测试用地1'),
('003', '华中农业大学实验田3', 114.355447, 30.465278, '湖北', '武汉', '测试用地3');

-- --------------------------------------------------------

--
-- 表的结构 `screen_base_citrus`
--

DROP TABLE IF EXISTS `screen_base_citrus`;
CREATE TABLE IF NOT EXISTS `screen_base_citrus` (
  `baseID` varchar(3) COLLATE utf8mb4_unicode_ci NOT NULL,
  `citrusOutput` float DEFAULT NULL,
  `year` date DEFAULT NULL
) ENGINE=MyISAM DEFAULT CHARSET=utf8mb4 COLLATE=utf8mb4_unicode_ci COMMENT='基地柑橘产量';
