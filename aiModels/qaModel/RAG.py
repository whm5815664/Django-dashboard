...
# ========== Ollama 配置==========
from aiModels.ollama_config import OLLAMA_BASE_URL, OLLANA_MODEL_NAME

OLLAMA_BASE_URL = OLLAMA_BASE_URL
MODEL_NAME = OLLANA_MODEL_NAME
...
# ========== 数据文件路径 ==========
# 知识库 JSON 文件已移动到 aiModels/agent/knowledge/agriculture_dat.json
# 这里通过相对 aiModels 应用根目录的路径来定位，避免受当前模块所在目录变动影响
DATA_PATH = (
    Path(__file__).resolve().parent.parent
    / "agent"
    / "knowledge"
    / "agriculture_dat.json"  # JSON: [{instruction,input,output}, ...]
)
