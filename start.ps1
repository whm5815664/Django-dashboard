...
# AIoT 农业智能问答系统启动器：数据库检查 + Django / OpenCode 独立启停
...
$AgentDir = Join-Path $ProjectRoot "aiModels\agent"
...
function Get-ProjectMutexName {
    ...
    $bytes = [System.Text.Encoding]::UTF8.GetBytes("AIoTDashboardLauncher:$normalized")
    ...
    return "Global\AIoTDashboardLauncher_$($hash.Substring(0, 16))"
}

$MutexName = Get-ProjectMutexName $ProjectRoot
...
function Get-DatabaseEnvPrefix {
    ...
    $pairs = [ordered]@{
        "${KeyPrefix}_HOST" = ([string]$Db.Host).Trim()
        "${KeyPrefix}_PORT" = ([string]$Db.Port).Trim()
        "${KeyPrefix}_NAME" = ([string]$Db.Name).Trim()
        "${KeyPrefix}_USER" = ([string]$Db.User).Trim()
        "${KeyPrefix}_PASSWORD" = ([string]$Db.Password).Trim()
    }
...
function Get-DatabasesEnvPrefix {
    param(
        [hashtable]$LocalDb,
        [hashtable]$ColdDb
    )
    return @(
        (Get-DatabaseEnvPrefix $LocalDb "DB")
        (Get-DatabaseEnvPrefix $ColdDb "PIG")
    ) -join " && "
}
...
function Write-DatabaseDotEnv {
    ...
    $entries = [ordered]@{}
    foreach ($prefix in @("DB", "PIG")) {
        $db = if ($prefix -eq "DB") { $LocalDb } else { $ColdDb }
        $entries["${prefix}_HOST"] = ([string]$db.Host).Trim()
        $entries["${prefix}_PORT"] = ([string]$db.Port).Trim()
        $entries["${prefix}_NAME"] = ([string]$db.Name).Trim()
        $entries["${prefix}_USER"] = ([string]$db.User).Trim()
        $entries["${prefix}_PASSWORD"] = ([string]$db.Password).Trim()
    }
    $existing = [ordered]@{}
...
import pymysql
try:
    conn = pymysql.connect(host='$($Db.Host)', port=$($Db.Port), user='$($Db.User)', password='$($Db.Password)', database='$($Db.Name)', connect_timeout=5)
    conn.close()
    print('OK')
except Exception as e:
    print('ERR:' + str(e))
"@
    $pyFile = Join-Path $env:TEMP "aiot_dashboard_db_check_$([Guid]::NewGuid().ToString('N')).py"
    [System.IO.File]::WriteAllText($pyFile, $py, [System.Text.UTF8Encoding]::new($false))
    try {
        $cmd = "$CondaPrefix && python `"$pyFile`""
        $output = & cmd.exe /c $cmd 2>&1 | Out-String
        if ($output -match "OK") { return $null }
        if ($output -match "ERR:(.+)") { return $Matches[1].Trim() }
        return $output.Trim()
    } finally {
...
function Show-ErrorBox {
    ...
    [System.Windows.Forms.MessageBox]::Show($Message, "AIoT 启动器", "OK", "Error") | Out-Null
}
...
$form.ClientSize = New-Object System.Drawing.Size(540, 530)

$grpDb = New-Object System.Windows.Forms.GroupBox
$grpDb.Text = "本地数据库"
$grpDb.Location = New-Object System.Drawing.Point(12, 12)
$grpDb.Size = New-Object System.Drawing.Size(516, 82)
...
$lblDbPassword.Text = "密码:"
$lblDbPassword.Location = New-Object System.Drawing.Point(12, 52)
$lblDbPassword.Size = New-Object System.Drawing.Size(40, 20)
$grpDb.Controls.Add($lblDbPassword)

$txtDbPassword = New-Object System.Windows.Forms.TextBox
$txtDbPassword.Location = New-Object System.Drawing.Point(52, 50)
$txtDbPassword.Size = New-Object System.Drawing.Size(112, 22)
$grpDb.Controls.Add($txtDbPassword)

$lblCondaEnv = New-Object System.Windows.Forms.Label
$lblCondaEnv.Text = "Anaconda 环境:"
$lblCondaEnv.Location = New-Object System.Drawing.Point(176, 52)
$lblCondaEnv.Size = New-Object System.Drawing.Size(96, 20)
$grpDb.Controls.Add($lblCondaEnv)

$txtCondaEnv = New-Object System.Windows.Forms.TextBox
$txtCondaEnv.Text = "weblab"
$txtCondaEnv.Location = New-Object System.Drawing.Point(272, 50)
$txtCondaEnv.Size = New-Object System.Drawing.Size(232, 22)
$grpDb.Controls.Add($txtCondaEnv)

$grpColdDb = New-Object System.Windows.Forms.GroupBox
$grpColdDb.Text = "冷库环境数据库"
$grpColdDb.Location = New-Object System.Drawing.Point(12, 100)
$grpColdDb.Size = New-Object System.Drawing.Size(516, 82)
$form.Controls.Add($grpColdDb)

$lblColdDbHost = New-Object System.Windows.Forms.Label
$lblColdDbHost.Text = "数据库 IP:"
$lblColdDbHost.Location = New-Object System.Drawing.Point(12, 26)
$lblColdDbHost.Size = New-Object System.Drawing.Size(72, 20)
$grpColdDb.Controls.Add($lblColdDbHost)

$txtColdDbHost = New-Object System.Windows.Forms.TextBox
$txtColdDbHost.Text = "47.99.61.189"
$txtColdDbHost.Location = New-Object System.Drawing.Point(84, 24)
$txtColdDbHost.Size = New-Object System.Drawing.Size(100, 22)
$grpColdDb.Controls.Add($txtColdDbHost)

$lblColdDbPort = New-Object System.Windows.Forms.Label
$lblColdDbPort.Text = "端口:"
$lblColdDbPort.Location = New-Object System.Drawing.Point(192, 26)
$lblColdDbPort.Size = New-Object System.Drawing.Size(40, 20)
$grpColdDb.Controls.Add($lblColdDbPort)

$txtColdDbPort = New-Object System.Windows.Forms.TextBox
$txtColdDbPort.Text = "3307"
$txtColdDbPort.Location = New-Object System.Drawing.Point(232, 24)
$txtColdDbPort.Size = New-Object System.Drawing.Size(52, 22)
$grpColdDb.Controls.Add($txtColdDbPort)

$lblColdDbName = New-Object System.Windows.Forms.Label
$lblColdDbName.Text = "数据库名:"
$lblColdDbName.Location = New-Object System.Drawing.Point(292, 26)
$lblColdDbName.Size = New-Object System.Drawing.Size(60, 20)
$grpColdDb.Controls.Add($lblColdDbName)

$txtColdDbName = New-Object System.Windows.Forms.TextBox
$txtColdDbName.Text = "pig"
$txtColdDbName.Location = New-Object System.Drawing.Point(356, 24)
$txtColdDbName.Size = New-Object System.Drawing.Size(148, 22)
$grpColdDb.Controls.Add($txtColdDbName)

$lblColdDbUser = New-Object System.Windows.Forms.Label
$lblColdDbUser.Text = "用户名:"
$lblColdDbUser.Location = New-Object System.Drawing.Point(12, 52)
$lblColdDbUser.Size = New-Object System.Drawing.Size(52, 20)
$grpColdDb.Controls.Add($lblColdDbUser)

$txtColdDbUser = New-Object System.Windows.Forms.TextBox
$txtColdDbUser.Text = "zb25"
$txtColdDbUser.Location = New-Object System.Drawing.Point(64, 50)
$txtColdDbUser.Size = New-Object System.Drawing.Size(100, 22)
$grpColdDb.Controls.Add($txtColdDbUser)

$lblColdDbPassword = New-Object System.Windows.Forms.Label
$lblColdDbPassword.Text = "密码:"
$lblColdDbPassword.Location = New-Object System.Drawing.Point(172, 52)
$lblColdDbPassword.Size = New-Object System.Drawing.Size(40, 20)
$grpColdDb.Controls.Add($lblColdDbPassword)

$txtColdDbPassword = New-Object System.Windows.Forms.TextBox
$txtColdDbPassword.Text = "zb123456"
$txtColdDbPassword.Location = New-Object System.Drawing.Point(212, 50)
$txtColdDbPassword.Size = New-Object System.Drawing.Size(292, 22)
$grpColdDb.Controls.Add($txtColdDbPassword)

$btnCheckDb = New-Object System.Windows.Forms.Button
$btnCheckDb.Text = "检查全部数据库连接"
$btnCheckDb.Location = New-Object System.Drawing.Point(12, 188)
$btnCheckDb.Size = New-Object System.Drawing.Size(516, 26)
$form.Controls.Add($btnCheckDb)

$grpDjango = New-Object System.Windows.Forms.GroupBox
$grpDjango.Text = "Django 配置"
$grpDjango.Location = New-Object System.Drawing.Point(12, 220)
...
$grpOpenCode.Location = New-Object System.Drawing.Point(12, 334)
...
$btnOpen.Text = "打开网页"
$btnOpen.Location = New-Object System.Drawing.Point(12, 456)
...
$btnStop.Text = "关闭服务"
$btnStop.Location = New-Object System.Drawing.Point(276, 456)
...
if ($saved) {
    $value = Get-LauncherConfigValue $saved 'dbHost'
    if ($value) { $txtDbHost.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'dbPort'
    if ($value) { $txtDbPort.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'dbName'
    if ($value) { $txtDbName.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'dbPassword'
    if ($null -ne $value) { $txtDbPassword.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'coldDbHost'
    if ($value) { $txtColdDbHost.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'coldDbPort'
    if ($value) { $txtColdDbPort.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'coldDbName'
    if ($value) { $txtColdDbName.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'coldDbUser'
    if ($value) { $txtColdDbUser.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'coldDbPassword'
    if ($null -ne $value) { $txtColdDbPassword.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'condaEnv'
    if ($value) { $txtCondaEnv.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'djangoPort'
    if ($value) { $txtDjangoPort.Text = ([string]$value).Trim() }
    $value = Get-LauncherConfigValue $saved 'openCodePort'
    if ($value) { $txtOpenCodePort.Text = ([string]$value).Trim() }
}
...
function Save-CurrentConfig {
    Save-LauncherConfig @{
        ...
        coldDbHost = $txtColdDbHost.Text.Trim()
        coldDbPort = $txtColdDbPort.Text.Trim()
        coldDbName = $txtColdDbName.Text.Trim()
        coldDbUser = $txtColdDbUser.Text.Trim()
        coldDbPassword = $txtColdDbPassword.Text
...
$btnCheckDb.Add_Click({
    try {
        $localDb = Get-DatabaseSettings $txtDbHost $txtDbPort $txtDbName $txtDbPassword -Label "本地数据库"
        $coldDb = Get-DatabaseSettings $txtColdDbHost $txtColdDbPort $txtColdDbName $txtColdDbPassword $txtColdDbUser -Label "冷库环境数据库"
        ...
        $localErr = Test-DatabaseConnection $localDb $prefix
        $coldErr = Test-DatabaseConnection $coldDb $prefix

        if ($localErr -or $coldErr) {
            $lines = @()
            if ($localErr) {
                $lines += "本地数据库失败：$localErr"
            } else {
                $lines += "本地数据库成功：$($localDb.Host):$($localDb.Port) / $($localDb.Name)"
            }
            if ($coldErr) {
                $lines += "冷库环境数据库失败：$coldErr"
            } else {
                $lines += "冷库环境数据库成功：$($coldDb.Host):$($coldDb.Port) / $($coldDb.Name)"
            }
            if ($localErr -or $coldErr) {
        ...
        [System.Windows.Forms.MessageBox]::Show(
            @(
                "全部数据库连接成功。"
                "本地：$($localDb.Host):$($localDb.Port) / $($localDb.Name)"
                "冷库：$($coldDb.Host):$($coldDb.Port) / $($coldDb.Name)"
            ) -join "`r`n",
            "数据库检查",
            "OK",
            "Information"
...
$btnStartDjango.Add_Click({
    ...
    try {
        ...
        Save-CurrentConfig
        Write-DatabaseDotEnv $localDb $coldDb $ProjectRoot
        $prefix = Get-CondaCmdPrefix $condaEnv
        $dbEnv = Get-DatabasesEnvPrefix $localDb $coldDb
        ...
        $script:djangoPid = Start-ServiceCmd "AIoT-Django" $djangoCmd
...
$btnStartOpenCode.Add_Click({
    ...
    try {
        ...
        if (-not (Test-Path $AgentDir)) { throw "未找到 aiModels\agent 目录。" }
        ...
        $script:opencodePid = Start-ServiceCmd "AIoT-OpenCode" $openCmd
